                            ...
                            return (
                                <div key={item.id} className="row shadow m-2 p-2">
                                    <div className="col-12">
                                        <div 
                                            onClick={()=>{if(window.confirm("Are you sure you want to delete ")){deleteData(item.id)}}} 
                ...
                <div className="shadow p-3">
                    ...
                    <form onSubmit={handleSubmit} id="form-contact" >
                        <div className="form-group">
                            <label for="email-contact">Title</label>
                            <input
                                type="text" className="form-control" id="title" aria-describedby="emailHelp"
                                value={values.title}
                        ...
                        <div className="form-group">
                            <label for="message-contact">Image</label>
                            <input
                                type="file"
                                name='image'
                                accept='.jpg, .jpeg'
                        ...
                        {/* <img src={`data:image/jpeg;base64,${values.image}`} alt="" /> */}
